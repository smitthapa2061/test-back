...
router.put('/:id', requireAuth, invalidateCacheMiddleware((req) => ['cache:/api/tournaments', 'cache:/api/public/tournaments/' + req.params.id]), tournamentController.updateTournament);
router.delete('/:id', requireAuth, invalidateCacheMiddleware((req) => ['cache:/api/tournaments', 'cache:/api/public/tournaments/' + req.params.id]), tournamentController.deleteTournament);
